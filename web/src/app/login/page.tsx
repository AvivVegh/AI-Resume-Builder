...
export default function LoginPage() {
  ...
  return (
    <div className="flex justify-center items-center min-h-screen bg-indigo-200/100	">
      <div className="flex flex-col items-center">
        <h1 className="font-title text-3xl font-mono font-medium text-center">
          Welcome to AI Resume Builder
        </h1>
        <p className="font-title text-l text-pretty w-2/4 font-medium text-center mt-10 font-mono">
        ...
        <div className="flex flex-row justify-center items-center mt-5">
          ...
          >
            <p className="font-medium font-mono text-l mr-0.5">Sign in with</p>
            <img
              className="w-6 h-6"
