...
myContainer
  .bind<DataService>(DataServiceType)
  .to(DataService)
  .inSingletonScope();
myContainer
  .bind<AssetsRepository>(AssetsRepositoryType)
  .to(AssetsRepository)
  .inSingletonScope();
myContainer
  .bind<FoldersRepository>(FolderRepositoryType)
  .to(FoldersRepository)
  .inSingletonScope();
